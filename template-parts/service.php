<section class="service container-big u-margin-top-big u-margin-bottom-big">
     <h1 class="heading-primary">Service</h1>
     <div class="service__content flex">
          <article class="service__content--item">
               <h3 class="heading-tertiary">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h3>
